...
@section('header')
    ...
    <section class="gaming-header border-0 w-100 h-100 position-relative d-flex flex-row justify-content-start align-items-center">
            <div class="gaming-header-info z-3">
                <div class="">
                    <h1 class="portfolio-h1 text-start text-white fw-bold scroll-fade scroll-left">
                        Kristian Nammensma,
                    </h1>
                    <p class="portfolio-p text-start gaming-header-sd scroll-fade scroll-left">Software Developer</p>
                </div>
    ...
    <div class="target-section m-0 p-0">
        <section class="w-100 h-100 position-relative p-5 d-flex flex-column justify-content-between">
            ...
            <section class="recentProject-cards d-flex flex-lg-row flex-column justify-content-evenly align-items-center">
                ...
                <div class="swiperAuto card col-lg-5 col-12 m-4 d-flex justify-content-center align-items-center overflow-hidden">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide w-100">
                            <img class="recent-img w-100" src="./css/image/game1.png" alt="">
                        </div>
                        <div class="swiper-slide w-100">
                            <img class="recent-img w-100" src="./css/image/game1-1.png" alt="">
                        </div>
                    </div>
        ...
        <section class="w-100 h-100 position-relative p-5 d-flex flex-column justify-content-between">
            <div class="header-txt col-12 d-flex justify-content-end flex-column p-lg-2 pe-lg-5 me-5">
            ...
            <section class="recentProject-cards d-flex flex-lg-row flex-column justify-content-evenly align-items-center">
                <div class="swiperAuto card col-lg-5 col-12 m-4 d-flex justify-content-center align-items-center overflow-hidden">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide w-100">
                            <img class="recent-img w-100" src="./css/image/game2.png" alt="">
                        </div>
                        <div class="swiper-slide w-100">
                            <img class="recent-img w-100" src="./css/image/game2-2.png" alt="">
                        </div>
                    </div>
